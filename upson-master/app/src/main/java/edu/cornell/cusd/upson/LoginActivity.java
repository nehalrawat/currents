...
//                ContactsContract.Contacts.Data.IS_PRIMARY + " DESC");
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            String passwordToHash = mPassword;
            ...
            try {
                ...
                urlName += URLEncoder.encode("'"+mPassword+"'", "UTF-8");
                ...
                try {
                    ...
                    is.close();
                    return sb.toString() != "" && sb.toString() != "Failed";
                } catch (IOException e) {
                    e.printStackTrace();
                }
